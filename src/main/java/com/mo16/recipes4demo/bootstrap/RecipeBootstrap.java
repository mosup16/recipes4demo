...
import com.mo16.recipes4demo.repositoris.Reactive.CategoryReactiveRepository;
import com.mo16.recipes4demo.repositoris.Reactive.RecipeReactiveRepository;
import com.mo16.recipes4demo.repositoris.Reactive.UnitOfMeasureReactiveRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public RecipeBootstrap(RecipeRepository recipeRepository, IngredientRepository ingredientRepository,
                           CategoryRepository categoryRepository, NotesRepository notesRepository,
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        System.out.println(recipes.size() + "ssssss");
//        int i = 1;
//       for (Recipe recipe : recipes){
//            recipe.setId("seq"+i);
//            for(Ingredient ingredient : recipe.getIngredients()){ingredient.setId("seq" + i);}
//            for(Category category :recipe.getCategories()){category.setId("seq" + i);}
//            recipe.getNotes().setId("seq" + i);
//            i++;
//        }
        recipeRepository.saveAll(recipes);
        log.error("count of UOMs : " + unitOfMeasureReactiveRepository.count().block());
